...
## Thread-лог симуляций

После каждого “стоп”:
1) Записать весь диалог симуляции в `kb/private/THREAD.md`
2) Формат в файле:
   - новая секция `## SIM YYYY-MM-DD HH:MM`
   - каждая строка — одно сообщение с ролью: `client:` или `bot:`
3) Симы в файле не смешивать: всегда добавлять новой секцией в конец.
