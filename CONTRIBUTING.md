...
- `kb/vector_upload/*.txt` и `kb/vector_upload.csv` — экспорт для загрузки в векторную базу/инструменты.
...
- `kb/vector_upload/…` и `kb/vector_upload.csv` (экспорт для векторизации).
